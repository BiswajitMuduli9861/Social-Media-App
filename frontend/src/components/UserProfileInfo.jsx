    ...
    return (
        <div className='relative py-4 px-6 md:px-8 bg-white'>
            <div className='flex flex-col md:flex-row items-center gap-6'>
                ...
                <div className='w-full pr-16 md:pt-0 md:pl-36'>
                    <div className='flex flex-col md:flex-row items-start justify-between'>
                        ...
                        {/* if user is not on others profile that means he is opening his profile so we like give edit button */}

                        {!profileId && <button onClick={() => setShowEdit(true)} className='!bg-white !text-black flex items-center gap-2 border border-gray-300 hover:!bg-gray-100 px-4 py-2 rounded-lg font-medium transition-colors mt-4 md:mt-0 cursor-pointer'>
