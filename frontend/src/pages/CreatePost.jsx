    ...
    <div className='min-h-screen bg-gradient-to-b from-slate-50 to-white'>
      <div className='max-w-6xl mx-auto p-6'>
        ...
        <div className='max-w-xl bg-white p-4 sm:pb-3 rounded-xl shadow-md space-y-4'>
          ...
          {/* Text Area */}
          <textarea onChange={(e) => setContent(e.target.value)} value={content} placeholder="What's happening?" className=' !bg-white !text-black w-full resize-none max-h-20 mt-4 text-sm outline-none !placeholder-gray-800 ' />
